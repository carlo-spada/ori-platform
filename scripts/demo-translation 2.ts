...
const DEMO_TRANSLATIONS = {
  ...
  es: {
    ...
    'Your AI-powered career companion':
      'Tu compañero de carrera impulsado por IA',
  },
  fr: {
    ...
    'Log in': 'Se connecter',
    'Your AI-powered career companion':
      'Votre compagnon de carrière alimenté par IA',
  },
  it: {
    ...
    'Log in': 'Accedi',
    'Your AI-powered career companion':
      'Il tuo compagno di carriera potenziato da IA',
  },
}
...
async function simulateTranslation(
  ...
  const translations =
    DEMO_TRANSLATIONS[targetLang as keyof typeof DEMO_TRANSLATIONS]
  return (
    translations[text as keyof typeof translations] || `[${targetLang}] ${text}`
  )
}
...
async function main() {
  ...
  console.log(
    '   Namespaces: 4 (translation, legal-terms, legal-privacy, legal-cookies)',
  )
  ...
  console.log(
    '   2. Run: DEEPL_API_KEY=your_key tsx scripts/sync-translations.ts',
  )
