...
export default function Profile() {
  ...
  const handleSaveExperience = (id: string | null, data: ExperienceFormData) => {
    if (id) {
  ...
  return (
    <div className="h-full flex flex-col gap-4" data-testid="profile-page">
      ...
      <div
        ...
        className="flex-1 overflow-y-auto rounded-2xl border border-border bg-card/50 backdrop-blur-sm p-4 sm:p-6"
      >
        {activeTab === 'profile' && (
          <ProfileForm
            value={profileData}
        ...
        {activeTab === 'qualifications' && (
          <QualificationsSection
            ...
            experienceModalLabels={{
              ...
              companyPlaceholder: t('profilePage.qualifications.experienceModal.companyPlaceholder'),
              ...
              descriptionPlaceholder: t('profilePage.qualifications.experienceModal.descriptionPlaceholder'),
            ...
            educationModalLabels={{
              ...
              institutionPlaceholder: t('profilePage.qualifications.educationModal.institutionPlaceholder'),
              ...
              descriptionPlaceholder: t('profilePage.qualifications.educationModal.descriptionPlaceholder'),
