...
export function JobDetailsCard({ job }: JobDetailsCardProps) {
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle className="text-lg">{t('jobDetailPage.details.heading')}</CardTitle>
      </CardHeader>
      <CardContent className="space-y-3">
        {job.datePosted && (
          <div className="flex flex-col gap-1">
            <span className="text-sm font-medium">{t('jobDetailPage.details.datePosted')}</span>
        ...
        {job.employmentType && (
          <div className="flex flex-col gap-1">
            <span className="text-sm font-medium">{t('jobDetailPage.details.employmentType')}</span>
            <span className="text-sm text-muted-foreground">{job.employmentType}</span>
          </div>
        )}
        {job.salaryRange && (
          <div className="flex flex-col gap-1">
            <span className="text-sm font-medium">{t('jobDetailPage.details.salaryRange')}</span>
