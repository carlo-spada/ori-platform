...
exports.hasReachedMatchLimit = hasReachedMatchLimit;
exports.getRemainingMatches = getRemainingMatches;
...
function calculateMatchScore(userSkills, jobRequirements) {
    if (!userSkills.length || !jobRequirements.length)
        return 0;
    const matches = jobRequirements.filter((req) => userSkills.some((skill) => skill.toLowerCase().includes(req.toLowerCase()) ||
