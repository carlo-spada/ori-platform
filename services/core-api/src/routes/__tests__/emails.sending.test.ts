...
describe('Email Sending - Template Rendering', () => {
  ...
  describe('Card expiring email template', () => {
    it('should render card expiring template with card details', () => {
      // Act
      const html = generateCardExpiringTemplate('John', 'Visa', '4242', 12, 2024);
    ...
    it('should include different card brands', () => {
      // Act
      const visaHtml = generateCardExpiringTemplate('User', 'Visa', '1234', 6, 2025);
      const mastercardHtml = generateCardExpiringTemplate('User', 'Mastercard', '5555', 9, 2025);
  ...
  describe('Trial ending email template', () => {
    it('should render trial ending template with days remaining', () => {
      // Act
      const html = generateTrialEndingTemplate('John', 3, 'Premium Monthly', 1000);
    ...
    it('should include CTA button with correct action', () => {
      // Act
      const html = generateTrialEndingTemplate('User', 5, 'Premium Monthly', 1000);
  ...
  describe('Subscription confirmation email template', () => {
    it('should render subscription confirmation with monthly plan', () => {
      // Act
      const html = generateSubscriptionConfirmationTemplate('John', 'Premium Monthly', 1000, 'monthly');
    ...
    it('should render subscription confirmation with yearly plan', () => {
      // Act
      const html = generateSubscriptionConfirmationTemplate('Jane', 'Plus Yearly', 4800, 'yearly');
    ...
    it('should include billing details table', () => {
      // Act
      const html = generateSubscriptionConfirmationTemplate('User', 'Premium', 1000, 'monthly');
    ...
    it('should include success styling', () => {
      // Act
      const html = generateSubscriptionConfirmationTemplate('User', 'Plus', 500, 'monthly');
  ...
  describe('Recommendations email template', () => {
    it('should render recommendations template with job count', () => {
      // Act
      const html = generateRecommendationsTemplate('John', 5, ['React', 'TypeScript', 'Node.js']);
    ...
    it('should include multiple skills', () => {
      // Act
      const html = generateRecommendationsTemplate('User', 10, ['Python', 'Machine Learning', 'Data Science', 'TensorFlow']);
  ...
  describe('Application status email template', () => {
    it('should render applied status', () => {
      // Act
      const html = generateApplicationStatusTemplate('John', 'Senior React Developer', 'Tech Corp', 'applied');
    ...
    it('should render reviewing status', () => {
      // Act
      const html = generateApplicationStatusTemplate('User', 'Product Manager', 'StartUp Inc', 'reviewing');
    ...
    it('should render shortlisted status with interview prep', () => {
      // Act
      const html = generateApplicationStatusTemplate('User', 'Engineer', 'Company', 'shortlisted');
    ...
    it('should render rejected status', () => {
      // Act
      const html = generateApplicationStatusTemplate('User', 'Designer', 'Agency', 'rejected');
    ...
    it('should render offer status', () => {
      // Act
      const html = generateApplicationStatusTemplate('User', 'CTO', 'Unicorn', 'offer');
    ...
    it('should include view applications link for all statuses', () => {
      const statuses = ['applied', 'reviewing', 'shortlisted', 'rejected', 'offer'] as const;

      statuses.forEach(status => {
        // Act
        const html = generateApplicationStatusTemplate('User', 'Role', 'Company', status);
