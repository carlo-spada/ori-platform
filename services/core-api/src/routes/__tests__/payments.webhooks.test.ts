...
describe('Stripe Webhooks - Event Handling', () => {
  ...
  describe('checkout.session.completed webhook', () => {
    ...
    it('should process checkout with unique session IDs', () => {
      // Act
      const event1 = testWebhookEvents.checkoutSessionCompleted(
        customerId,
        subscriptionId,
      )
      const event2 = testWebhookEvents.checkoutSessionCompleted(
        customerId,
        subscriptionId,
      )
  ...
  describe('customer.subscription.created webhook', () => {
    it('should handle subscription created event', () => {
      // Arrange
      const event = testWebhookEvents.customerSubscriptionCreated(
        customerId,
        subscriptionId,
      )
  ...
  describe('customer.subscription.deleted webhook', () => {
    it('should handle subscription deleted event', () => {
      // Arrange
      const event = testWebhookEvents.customerSubscriptionDeleted(
        customerId,
        subscriptionId,
      )
...
describe('Webhook Event Structure Validation', () => {
  it('should validate all events have type and data', () => {
    ...
    const events = [
      ...
      testWebhookEvents.customerSubscriptionUpdated(
        customerId,
        subscriptionId,
        'active',
      ),
      ...
      testWebhookEvents.invoicePaymentFailed(
        customerId,
        `in_test_456`,
        subscriptionId,
      ),
