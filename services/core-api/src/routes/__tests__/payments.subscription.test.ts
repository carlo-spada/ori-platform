...
describe('Payment - Subscription Creation', () => {
  ...
  describe('Creating a subscription', () => {
    ...
    it('should create subscription with correct billing cycle dates', () => {
      // Act
      const subscription = createTestSubscription(customerId, testPlans.plusMonthly.priceId);
  ...
  describe('Subscription status management', () => {
    it('should create active subscription', () => {
      // Act
      const subscription = createTestSubscription(customerId, testPlans.plusMonthly.priceId, 'active');
  ...
  describe('Subscription ID format', () => {
    it('should generate unique subscription IDs', () => {
      // Act
      const sub1 = createTestSubscription(customerId, testPlans.plusMonthly.priceId);
      const sub2 = createTestSubscription(customerId, testPlans.plusYearly.priceId);
  ...
  describe('Subscription billing details', () => {
    it('should set correct product ID based on price', () => {
      // Act
      const plusSub = createTestSubscription(customerId, testPlans.plusMonthly.priceId);
      const premiumSub = createTestSubscription(customerId, testPlans.premiumMonthly.priceId);
    ...
    it('should set correct interval for yearly plans', () => {
      // Act
      const subscription = createTestSubscription(customerId, testPlans.plusYearly.priceId);
  ...
  describe('Multiple subscriptions for same customer', () => {
    it('should allow creating multiple subscriptions for testing', () => {
      // Act
      const sub1 = createTestSubscription(customerId, testPlans.plusMonthly.priceId);
      const sub2 = createTestSubscription(customerId, testPlans.premiumYearly.priceId);
  ...
  describe('Subscription tier pricing', () => {
    it('should support Plus Monthly tier ($5/month)', () => {
      ...
      // Assert
      expect(subscription.items.data[0].price.id).toBe(testPlans.plusMonthly.priceId);
    ...
    it('should support Plus Yearly tier ($48/year)', () => {
      ...
      // Assert
      expect(subscription.items.data[0].price.id).toBe(testPlans.plusYearly.priceId);
