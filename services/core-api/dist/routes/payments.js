...
router.post('/checkout', auth_js_1.authMiddleware, (0, validation_js_1.validateRequest)(createCheckoutSchema), async (req, res, next) => {
    try {
...
router.post('/portal', auth_js_1.authMiddleware, async (req, res, next) => {
    try {
