...
describe('Email Notification Preferences', () => {
    ...
    describe('Global unsubscribe functionality', () => {
        ...
        it('should generate unique unsubscribe token per user', () => {
            // Act
            const prefs1 = (0, email_fixtures_1.createTestNotificationPreferences)('user_123');
            const prefs2 = (0, email_fixtures_1.createTestNotificationPreferences)('user_456');
            // Assert
    ...
    describe('Preference combinations and logic', () => {
        ...
        it('should track preference change history in metadata', () => {
            // Arrange
            const basePreferences = (0, email_fixtures_1.createTestNotificationPreferences)('user_123');
            // Act
            const updatedPreferences = {
                ...basePreferences,
                payment_failure_emails: false,
            ...
            // Assert
            expect(updatedPreferences.metadata?.lastChangeType).toBe('disabled_payment_failure_emails');
    ...
    describe('Preference validation and constraints', () => {
        ...
        it('should have unique preference ID', () => {
            // Act
            const prefs1 = (0, email_fixtures_1.createTestNotificationPreferences)('user_123');
            const prefs2 = (0, email_fixtures_1.createTestNotificationPreferences)('user_123');
    ...
    describe('Preference bulk updates', () => {
        it('should update multiple preferences at once', () => {
            // Arrange
            const originalPreferences = (0, email_fixtures_1.createTestNotificationPreferences)('user_123');
            // Act
            const updatedPreferences = {
                ...originalPreferences,
                payment_failure_emails: false,
        ...
        it('should reset all preferences to defaults', () => {
            // Arrange
            const customPreferences = (0, email_fixtures_1.createTestNotificationPreferences)('user_123', {
                payment_failure_emails: false,
                card_expiring_emails: false,
                recommendation_emails: false,
                weekly_digest: true,
            ...
            const resetPreferences = (0, email_fixtures_1.createTestNotificationPreferences)('user_123');
            // Assert
...
//# sourceMappingURL=emails.preferences.test.js.map