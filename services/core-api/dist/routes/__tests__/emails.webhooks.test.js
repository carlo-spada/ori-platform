...
describe('Email Webhook Integration', () => {
    ...
    describe('Complex webhook scenarios', () => {
        ...
        it('should handle payment lifecycle: failed → update reminder → success', () => {
            // Arrange
            const paymentFailureNotif = (0, email_fixtures_1.createTestNotification)({
                type: 'payment_failure',
                triggered_by_event: 'charge.failed',
            });
            const cardExpiringNotif = (0, email_fixtures_1.createTestNotification)({
                type: 'card_expiring',
                triggered_by_event: 'customer.source.expiring.soon',
            });
            const successNotif = (0, email_fixtures_1.createTestNotification)({
                type: 'subscription_confirmation',
...
//# sourceMappingURL=emails.webhooks.test.js.map