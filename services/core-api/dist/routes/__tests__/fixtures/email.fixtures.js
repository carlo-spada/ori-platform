...
exports.notificationDatabaseFixtures = exports.emailTemplates = exports.notificationScenarios = exports.notificationEmailMap = void 0;
exports.createTestNotification = createTestNotification;
exports.createTestNotificationPreferences = createTestNotificationPreferences;
exports.createMockResendResponse = createMockResendResponse;
 ...
 */
function createTestNotificationPreferences(userId, overrides) {
    const timestamp = new Date().toISOString();
    return {
 ...
 */
function createMockResendResponse(overrides) {
    const randomId = Math.random().toString(36).substr(2, 9);
    return {
 ...
 */
function generateEmailHTML(type, variables) {
    const baseHTML = `
    <!DOCTYPE html>
    <html>
      <head>
 ...
 */
function generateUnsubscribeLink(token) {
 ...
 */
exports.notificationDatabaseFixtures = {
    /**
     * Create test notification record
     */
    createNotificationRecord: (userId, type, status = 'sent') => {
    ...
    createNotificationHistory: (userId, count = 5) => {
        ...
        return Array.from({ length: count }, (_, index) => createTestNotification({
            user_id: userId,
...
//# sourceMappingURL=email.fixtures.js.map