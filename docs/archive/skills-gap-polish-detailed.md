...
>
  ...
  >
    <CheckCircle className="h-3.5 w-3.5 text-green-500" aria-label="Matched" />
...
{
  isExpanded && <div className="space-y-3">{/* Skills sections */}</div>
}
```
...
```tsx
<div className="group flex items-center gap-1.5 rounded-md border border-red-500/20 bg-red-500/10 px-2.5 py-1">
